...
---
 ...
 started off this CTF, [Cyborg](https://tryhackme.com/r/room/cyborgt8), by performing an nmap scan to check for running services on the target machine. The following is the output:
